        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                name: "admin.flow.entry_list",
                path: "entry_list",
                component: () =>
                  import("@/views/admin/base/flow/entry_list.vue"),
                meta: {
                  title: "流程实例",
          ...
          },
          {
            name: "admin.cc",
            path: "cc",
            component: () => import("@/views/admin/base/cc/index.vue"),
            meta: {
              title: "抄送记录",
              menu: { title: "抄送记录", icon: "MailOutlined", order: 900 },
            },
          },
        ],
      },
